...
import {Colors, Criteria} from '@ui/atoms/pip-password-strength/enum';
import {PasswordStrengthValidator} from '@ui/atoms/pip-password-strength/validator/password-strength-validator';
import {RegExpValidator} from '@ui/atoms/pip-password-strength/validator/regexp.class';


@Component({
  selector: 'pip-password-strength',
  templateUrl: './pip-password-strength.component.html',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => PipPasswordStrengthComponent),
      multi: true
    }
  ],
})
export class PipPasswordStrengthComponent implements OnInit, OnChanges, AfterContentChecked, ControlValueAccessor {
  ...
  matPasswordStrengthValidator = new PasswordStrengthValidator();
