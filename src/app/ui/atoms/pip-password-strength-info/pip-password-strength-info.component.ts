...
@Component({
  selector: 'pip-password-strength-info',
  imports: [
    MatIcon,
    NgClass
  ],
  templateUrl: './pip-password-strength-info.component.html',
  styleUrls: ['./pip-password-strength-info.component.scss'],
  animations: [
...
export class PipPasswordStrengthInfoComponent implements OnInit {

  @Input()
  passwordComponent!: PipPasswordStrengthComponent;
